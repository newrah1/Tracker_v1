...
class Ui_PopUp_Add_Firearm(QMainWindow):
	...
	def WriteToDB(self):
		try:
            ...
            VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"""
							  % (name, manufacturer, model, sku, caliber, atype, type, olength,
								 blength, weight,
	...
	def setupUi(self, PopUp_Add_Firearm):
		...
		# self.AddFirearm_BTN.clicked.connect(lambda: self.close())
		# Name
