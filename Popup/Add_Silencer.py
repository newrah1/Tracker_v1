...
# Form implementation generated from reading ui file 'PopUp_Add_Silencer.ui'
#
...
class Ui_PopUp_Add_Silencer(object):
    ...
    def setupUi(self, PopUp_Add_Silencer):
        ...
        PopUp_Add_Silencer.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.centralwidget = QtWidgets.QWidget(PopUp_Add_Silencer)
        ...
        # Add Silencer BTN
        self.AddSilencer_BTN = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.gridLayout.addWidget(self.OverLength_TE, 5, 1, 1, 1)
        self.OverLength = QtWidgets.QLabel(self.gridLayoutWidget)
        self.OverLength.setObjectName("OverLength")
        self.gridLayout.addWidget(self.OverLength, 5, 0, 1, 1)
        # Weight
        self.Weight_LBL = QtWidgets.QLabel(self.gridLayoutWidget)
        self.Weight_LBL.setObjectName("Weight_LBL")
        self.gridLayout.addWidget(self.Weight_LBL, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Weight_TE, 6, 1, 1, 1)
        # Diameter
        self.Diameter_TE = QtWidgets.QTextEdit(self.gridLayoutWidget)
        self.Diameter_TE.setMaximumSize(QtCore.QSize(16777215, 30))
        self.Diameter_TE.setObjectName("Diameter_TE")
        self.gridLayout.addWidget(self.Diameter_TE, 7, 1, 1, 1)
        self.Diameter_LBL = QtWidgets.QLabel(self.gridLayoutWidget)
        self.Diameter_LBL.setObjectName("Diameter_LBL")
        self.gridLayout.addWidget(self.Diameter_LBL, 7, 0, 1, 1)
        # Slot 12
        ...
        self.retranslateUi(PopUp_Add_Silencer)
        QtCore.QMetaObject.connectSlotsByName(PopUp_Add_Silencer)

    def retranslateUi(self, PopUp_Add_Silencer):
        _translate = QtCore.QCoreApplication.translate
        PopUp_Add_Silencer.setWindowTitle(_translate("PopUp_Add_Silencer", "Add Silencer"))
        self.Name_LBL.setText(_translate("PopUp_Add_Silencer", "Name"))
        self.Manufacturer_LBL.setText(_translate("PopUp_Add_Silencer", "Manufacturer"))
        self.Model_LBL.setText(_translate("PopUp_Add_Silencer", "Model"))
        self.SKU_LBL.setText(_translate("PopUp_Add_Silencer", "SKU"))
        self.Caliber_LBL.setText(_translate("PopUp_Add_Silencer", "Caliber"))
        self.OverLength.setText(_translate("PopUp_Add_Silencer", "Overall Length Inch"))
        self.Weight_LBL.setText(_translate("PopUp_Add_Silencer", "Weight lb"))
        self.Diameter_LBL.setText(_translate("PopUp_Add_Silencer", "Diameter Inch"))
        self.Notes_LBL.setText(_translate("PopUp_Add_Silencer", "Notes"))
        self.Picture_LBL.setText(_translate("PopUp_Add_Silencer", "Picture"))
        self.Slot_12_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 12"))
        self.Slot_13_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 13"))
        self.Slot_14_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 14"))
        self.Slot_15_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 15"))
        self.Slot_16_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 16"))
        self.Slot_17_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 17"))
        self.Slot_18_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 18"))
        self.Slot_19_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 19"))
        self.Slot_20_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 20"))
        self.Slot_21_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 21"))
        self.Slot_22_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 22"))
        self.Slot_23_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 23"))
        self.Slot_24_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 24"))
        self.Slot_25_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 25"))
        self.Slot_26_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 26"))
        self.Slot_27_LBL.setText(_translate("PopUp_Add_Silencer", "Slot 27"))
        self.AddSilencer_BTN.setText(_translate("PopUp_Add_Silencer", "Add Silencer"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    PopUp_Add_Silencer = QtWidgets.QMainWindow()
    ui = Ui_PopUp_Add_Silencer()
    ui.setupUi(PopUp_Add_Silencer)
    PopUp_Add_Silencer.show()
    sys.exit(app.exec_())
