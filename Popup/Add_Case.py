...
class Ui_PopUp_Add_Case(object):
    ...
    def WriteToDB(self):
        try:
            ...
            finish = self.Finish_TE.toPlainText()
            primersize = self.PrimerSize_TE.toPlainText()
            ...
            sql = '{}'.format("""INSERT INTO Case_table 
               (Name, Manufacturer, Model, SKU, Finish, Primer_Size, Notes, Picture) 
               VALUES
               ('%s','%s','%s','%s','%s','%s','%s','%s')"""
                              % (
                                  name, manufacturer, model, sku, finish, primersize, note, picture)
                              )
    ...
    def setupUi(self, PopUp_Add_Case):
        ...
        self.AddCase_BTN.clicked.connect(lambda: self.WriteToDB())
