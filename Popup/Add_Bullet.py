...
class Ui_PopUp_Add_Bullet(object):
    def setupUi(self, PopUp_Add_Bullet):
        ...
        self.gridLayout.addWidget(self.BaseLBL, 8, 0, 1, 1)
        ...
        self.Type_LBL_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.Type_LBL_2.setObjectName("Type_LBL_2")
        self.gridLayout.addWidget(self.Type_LBL_2, 5, 0, 1, 1)
        self.Length_LBL = QtWidgets.QLabel(self.gridLayoutWidget)
        self.Length_LBL.setObjectName("Length_LBL")
        self.gridLayout.addWidget(self.Length_LBL, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Type_TE_2, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Size_mm_TE, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Caliber_TE, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Length_TE, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Base_TE, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Size_Inch_TE, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.BC_TE, 9, 1, 1, 1)
    ...
    def retranslateUi(self, PopUp_Add_Bullet):
        ...
        self.Type_LBL_2.setText(_translate("PopUp_Add_Bullet", "Type"))
        ...
        self.Slot_12_LBL.setText(_translate("PopUp_Add_Bullet", "Slot 12"))
